...
const majorData = {
    ...
    '土木工程检测技术': {
        dept: '测绘与检测学院', duration: '3年',
        intro: '国家"双高"建设专业、国家骨干院校建设专业，2021年"金平果"专业排名位列全国第一。掌握土木工程材料试验检测、高性能混凝土组成设计及性能检测方法，具备路基路面、桥梁、隧道工程施工试验与检测能力，精通工地试验室组建与管理。',
        courses: ['土木工程材料试验与检测', '路基路面试验与检测', '桥梁工程试验与检测', '隧道工程试验与检测', '现代混凝土试验检测与工程应用', '轨道线路检测'],
        jobs: ['试验检测员', '工地试验室主管', '工程质量检测工程师', '铁路线路养护维修技术员'],
        features: ['国家"双高"建设专业', '全国排名第一', '央企对口就业']
    },
    '摄影测量与遥感技术': {
        dept: '测绘与检测学院', duration: '3年',
        intro: '培养掌握摄影测量、工程控制测量、数字测图等技术，具备摄影测量与遥感影像获取、图形图像信息处理、影像解译和分析能力的技术技能人才。适应测绘地理信息、交通、城建、国土资源等行业需要。',
        courses: ['摄影测量基础', '数字摄影测量', '遥感数字图像处理', 'GPS测量技术与应用', '地图与地图制图', '地理信息系统技术应用'],
        jobs: ['摄影测量技术员', '遥感数据处理员', '测绘工程师', 'GIS数据工程师'],
        features: ['遥感技术前沿方向', '行业需求持续增长', '就业领域广泛']
    },
    '无人机测绘技术': {
        dept: '测绘与检测学院', duration: '3年',
        intro: '培养掌握无人机低空摄影测量、影像数据处理、无人机操控与装调能力的高素质技能人才。无人机测绘是新兴技术方向，广泛应用于城市规划、轨道交通、智慧城市建设等领域。',
        courses: ['无人机操控技术', '无人机测绘技术与应用', '无人机组装与调试', 'GNSS测量技术与应用', '数字测图', '测绘程序设计与应用'],
        jobs: ['无人机操控员', '无人机测绘数据处理员', '测绘技术员', '智慧城市数据采集员'],
        features: ['新兴热门方向', '技术含量高', '就业前景广阔']
    },
